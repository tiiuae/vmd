        ...
        context: &C) -> Result<GetVmInfoByIdResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = serde_json::from_str::<models::VirtualMachineInfo>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(GetVmInfoByIdResponse::SuccessfulOperation
                    (body)
                )
            }
            400 => {
            ...
            0 => {
                ...
                Ok(GetVmInfoByIdResponse::ErrorPayload
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetVmListResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetVmListResponse::ListOfIDsForAllVirtualMachines
                    (body)
                )
            }
            0 => {
                ...
                Ok(GetVmListResponse::ErrorPayload
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<VmActionResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(VmActionResponse::SuccessfulOperation
                    (body)
                )
            }
            400 => {
            ...
            0 => {
                ...
                Ok(VmActionResponse::ErrorPayload
                    (body)
                )
            }
            code => {
